...
import java.util.*;
     ...
     */
    public final class Main1 implements Closeable {
        /** UTF-8 charset. */
        ...
        public static void main(final String... args) throws IOException {
            // create session
            try(Main session = new Main("localhost", 1984, "admin", "admin")) {
                // initialize timer
                ...
                final String// input = "for $i in 1 to 10 return <xml>Text { $i }</xml>";
                        ...
                        input = " declare namespace ns2 = \"http://zakupki.gov.ru/oos/export/1\";\n" +
                        "declare default element namespace \"http://zakupki.gov.ru/oos/types/1\";\n" +
                        "for $i in collection(\"Contract\")/ns2:export/ns2:contract/customer return ($i/fullName/data(), $i/inn/data(),$i/legalForm/data())";

                String sq1 = " declare namespace ns2 = \"http://zakupki.gov.ru/oos/export/1\"; " +
                        "declare default element namespace \"http://zakupki.gov.ru/oos/types/1\"; " +
                        "for $i in collection(\"Contract\")/ns2:export/ns2:contract/customer/fullName return " +
                        "$i/data()";

                final long time = System.nanoTime();

                System.out.println(session.execute("xquery" + sq1));
...
*/
         ...
         */
        public Main(final String host, final int port, final String username,
